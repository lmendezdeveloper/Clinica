<%@ Page Title="" Language="C#" MasterPageFile="~/view/administrador/master_administrador.Master" AutoEventWireup="true" CodeBehind="reporte_diario.aspx.cs" Inherits="Clinica.view.administrador.reporte_diario" %>
                ...
                <div class="card card-color mb-3 col-md-12 h-100 d-inline-block">
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col-10">
                                <br />
                                <h3 class="card-title">Atenciones diarias</h3>
                            </div>
                            <div class="col-md-2">
